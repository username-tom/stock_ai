...
class PortfolioManagerSettings(Base):
    ...
    sim_buy_fill_rate_pct = Column(Float, default=60.0, nullable=False)
    sim_sell_fill_rate_pct = Column(Float, default=70.0, nullable=False)
    auto_trade_buy_price_offset_pct = Column(Float, default=0.145, nullable=False)
    auto_trade_sell_price_offset_pct = Column(Float, default=0.185, nullable=False)

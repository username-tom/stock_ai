...
async def _migrate(conn):
    ...
    migrations = [
        ...
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_no_loss_full_alloc_only BOOLEAN NOT NULL DEFAULT 1",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_no_loss_emergency_cap_pct REAL NOT NULL DEFAULT 10.0",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_fill_near_sl_enabled BOOLEAN NOT NULL DEFAULT 0",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_fill_near_sl_distance_pct REAL NOT NULL DEFAULT 0.25",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_fill_near_sl_size_pct REAL NOT NULL DEFAULT 50.0",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_sl_tp_decay_enabled BOOLEAN NOT NULL DEFAULT 0",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_sl_tp_decay_bars INTEGER NOT NULL DEFAULT 120",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_sl_decay_total_pct REAL NOT NULL DEFAULT 50.0",
        "ALTER TABLE portfolio_manager_settings ADD COLUMN ai_tp_decay_total_pct REAL NOT NULL DEFAULT 80.0",
